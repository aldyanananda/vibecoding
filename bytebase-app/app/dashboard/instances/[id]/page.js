...
function EngineIcon({ engine, size = 22 }) {
        ...
        <div style={{ maxWidth: '760px' }}>
          ...
          <div style={{ marginBottom: '1.5rem', padding: '1rem', backgroundColor: '#f9fafb', borderRadius: '8px', border: '1px solid #e5e7eb' }}>
            ...
            <div style={{ fontSize: '0.8rem', color: '#6b7280', marginBottom: '0.75rem' }}>
              Bytebase periodically syncs instance schema and detects anomalies.
            </div>
                ...
                <tbody>
                  {databases.map((db, idx) => (
                    <tr key={db} style={{ borderBottom: '1px solid #f3f4f6' }}
                      ...
                      <td style={{ padding: '0.75rem 1rem' }}>
                        <button style={{ background: 'none', border: '1px solid #e5e7eb', borderRadius: '4px', padding: '0.25rem 0.75rem', fontSize: '0.75rem', cursor: 'pointer', color: '#4f46e5' }}>
                          Open SQL Editor
                        </button>
                      </td>
                    </tr>
